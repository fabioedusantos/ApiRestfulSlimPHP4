...
class AuthFlowTest extends BaseFlow
{
    ...
    public function testIsLoggedInBySignupGoogleSucesso(): void
    {
        $token = $this->testSignupGoogleSucesso();
        $this->isLoggedIn($token);
    }
    ...
    public function testRefreshTokenLoginGoogleSucesso(): array
    {
        $token = $this->testLoginGoogleSucesso();
        return $this->refreshToken($token);
    }

    public function testIsLoggedInByRefreshTokenLoginGoogleSucesso(): void
    {
        $token = $this->testRefreshTokenLoginGoogleSucesso();
        $this->isLoggedIn($token);
    }
