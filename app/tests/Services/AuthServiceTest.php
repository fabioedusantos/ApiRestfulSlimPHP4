...
class AuthServiceTest extends TestCase
{
    ...
    public function testSignupGoogleFalhaTokenFirebaseInvalidoException(): void
    {
        $recaptchaHelper = Mockery::mock('overload:' . GoogleRecaptchaHelper::class);
        $recaptchaHelper->shouldReceive('isValid')
            ->once()
    ...
    public function testSignupGoogleFalhaPolitica(): void
    {
        $recaptchaHelper = Mockery::mock('overload:' . GoogleRecaptchaHelper::class);
        $recaptchaHelper->shouldReceive('isValid')
            ->once()
    ...
    public function testSignupGoogleFalhaGerarToken(): void
    {
        $firebaseToken = "FaKeFirebaseTokenFaKeFirebas";
        $nome = "Fábio";
        $sobrenome = "Santos";
    ...
    public function testSignupGoogleFalhaGerarRefreshToken(): void
    {
        $firebaseToken = "FaKeFirebaseTokenFaKeFirebas";
        $nome = "Fábio";
        $sobrenome = "Santos";
    ...
    public function testLoginGoogleFalhaRecaptcha(): void
    {
        $recaptchaHelper = Mockery::mock('overload:' . GoogleRecaptchaHelper::class);
        $recaptchaHelper->shouldReceive('isValid')
            ->andReturn(false);
    ...
    public function testLoginGoogleFalhaAtualizarFotoUsuario(): void
    {
        $recaptchaHelper = Mockery::mock('overload:' . GoogleRecaptchaHelper::class);
        $recaptchaHelper->shouldReceive('isValid')
            ->once()
        ...
        $this->userRepository->method('getByFirebaseUid')->willReturn($this->userData);
        $this->userRepository->method('updatePhotoBlob')->willReturn(false);
    ...
    public function testLoginGoogleFalhaAtualizarUltimoAcessoException(): void
    {
        $recaptchaHelper = Mockery::mock('overload:' . GoogleRecaptchaHelper::class);
        $recaptchaHelper->shouldReceive('isValid')
            ->once()
